...
export const CodeCard = () => {
  const [text, setText] = useState(`new Date().getFullYear() - 1999;`);
  ...
  return (
    <CodeCardWrapper>
      ...
      <pre>3&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Person() {'{'}</pre>
      <pre>
        4&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.name = "<b>SUJITH V I</b>";
      </pre>
      <pre>
        5&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.traits = ["<b>RESEARCH</b>", "<b>DEVELOP</b>","<b>DEPLOY</b>"];
      </pre>
      <pre onClick={changeText}>6&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; this.age = {text}</pre>
      <pre>7&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; {'}'}</pre>
      <pre>8&nbsp;&nbsp;{'}'}</pre>
    </CodeCardWrapper>
  );
